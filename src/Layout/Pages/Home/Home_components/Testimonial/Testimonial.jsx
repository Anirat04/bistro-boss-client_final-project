            ...
            >
                {
                    reviewData.map(review => (
                        <SwiperSlide key={review._id}>
                            <div className='text-center flex flex-col items-center px-[220px]'>
                                <Rating
                                    style={{ maxWidth: 180 }}
                                    value={review.rating}
                                    readOnly
                                ...
                                <p className='leading-9 text-[20px] text-[#444] mt-[40px]'>{review.details}</p>
                                <h3 className='text-[32px] font-medium text-[#CD9003] uppercase'>{review.name}</h3>
                            </div>
                        </SwiperSlide>
                    ))
                }
